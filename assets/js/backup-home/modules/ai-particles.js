...
export const AI_PARTICLE_PRESETS = [
  ...
  { count: 275, mobileCount: 175, size: 2, speed: 0.8, opacity: 0.6, lineDistance: 140, lineOpacity: 0.26, lineWidth: 0.6 },
  // SLIDE 2 — Connected intelligence: closer, more interconnected network.
  { count: 375, mobileCount: 275, size: 1, speed: 1.8, opacity: 0.4, lineDistance: 100, lineOpacity: 0.26, lineWidth: 0.5 },
  // SLIDE 3 — Same total particle budget as slide 2, shared across four globes.
  { count: 975, mobileCount: 245, size: 1, speed: 5.8, opacity: 0.2, lineDistance: 140, lineOpacity: 0.16, lineWidth: 0.5 },
];
